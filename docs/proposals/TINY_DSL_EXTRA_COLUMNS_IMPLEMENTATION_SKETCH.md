...
- Scope: implementation approach for the tiny DSL proposed in [docs/proposals/INTRODUCE_TINY_DSL_IN_EXTRA_COLUMNS.md](docs/proposals/INTRODUCE_TINY_DSL_IN_EXTRA_COLUMNS.md)
...
10. ✅ added extensibility guide (DSL_EXTENSIBILITY_GUIDE.md)
...
For adding new features, see [docs/proposals/DSL_EXTENSIBILITY_GUIDE.md](DSL_EXTENSIBILITY_GUIDE.md).
