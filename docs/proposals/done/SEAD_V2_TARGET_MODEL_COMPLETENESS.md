...
| Taxonomy and ecology extensions | `tbl_taxa_common_names`, `tbl_taxa_synonyms`, `tbl_taxa_measured_attributes`, `tbl_rdb`, `tbl_rdb_codes`, `tbl_rdb_systems`, `tbl_ecocodes`, `tbl_ecocode_groups`, `tbl_ecocode_systems` | `taxa_tree_master`, `taxa_common_names`, `taxa_synonyms`, `taxa_measured_attributes`, `ecocode_system`, `ecocode_group`, `ecocode_definition`, `ecocode`, `rdb_system`, `rdb_code`, and `rdb` | already covered | The branch now models the main taxonomy, ecocode, and Red Data Book slice as shared SEAD concepts in the superset target model. |
...
- [docs/proposals/CHANGE_REQUEST_INGESTER/archive/closed_delivery_1/DELIVERY_1_FOLLOWUP_CR.md](../CHANGE_REQUEST_INGESTER/archive/closed_delivery_1/DELIVERY_1_FOLLOWUP_CR.md)
