...
For extensibility guide, see [docs/other/DSL_EXTENSIBILITY_GUIDE.md](../../other/DSL_EXTENSIBILITY_GUIDE.md).
...
For extending the DSL with new functions or expression types, see [docs/other/DSL_EXTENSIBILITY_GUIDE.md](../../other/DSL_EXTENSIBILITY_GUIDE.md).
