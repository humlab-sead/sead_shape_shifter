...
- Authorization sub-proposal: [CENTRALIZED_AUTHORIZATION_SYSTEM.md](./CENTRALIZED_AUTHORIZATION_SYSTEM.md)
...
The resource authorization model and implementation sequence are defined in [CENTRALIZED_AUTHORIZATION_SYSTEM.md](./CENTRALIZED_AUTHORIZATION_SYSTEM.md) and [CENTRALIZED_AUTHORIZATION_SYSTEM_TASK_PLAN.md](./CENTRALIZED_AUTHORIZATION_SYSTEM_TASK_PLAN.md).
