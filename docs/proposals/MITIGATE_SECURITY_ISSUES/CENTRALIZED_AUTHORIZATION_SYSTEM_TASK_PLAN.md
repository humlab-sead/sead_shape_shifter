...
| Shared and administrative resources | In progress | Shared data source listings now return only sources with readable grants. Ingester execution also depends on capability restrictions |
