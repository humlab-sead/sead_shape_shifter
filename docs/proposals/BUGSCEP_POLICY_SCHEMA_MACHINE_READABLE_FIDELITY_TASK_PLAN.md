...
| Validate and sync companion docs | In progress | Focused validation is green for this slice; remaining work is to rerun `make validate-policy-format` after the latest contract batches and keep the companion proposal set aligned as more families are upgraded. |
