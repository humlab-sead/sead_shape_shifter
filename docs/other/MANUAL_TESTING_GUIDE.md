# Shape Shifter - Manual Testing Guide
...
> For the testing strategy, automated test levels, and test commands see [../TESTING.md](../TESTING.md).
...
1. Open browser
2. Navigate to https://shape-shifter.sead.se/
