...
def settings(monkeypatch):
    ...
    monkeypatch.setenv("SHAPE_SHIFTER_GLOBAL_DATA_DIR", "backend/tests/test_data/projects/shared/shared-data")
    monkeypatch.setenv("SHAPE_SHIFTER_GLOBAL_DATA_SOURCE_DIR", "backend/tests/test_data/projects/shared/data-sources")
