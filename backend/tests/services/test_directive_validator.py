...
class TestDirectiveValidator:
    ...
    def test_validate_fk_directive_valid_list(self, validator):
        ...
        result = validator.validate_foreign_key_directive("site", "location", "@value:entities.location.keys", is_local=False)
    ...
    def test_validate_fk_directive_invalid_type(self, validator):
        ...
        result = validator.validate_foreign_key_directive("site", "location", "@value:entities.location.public_id", is_local=False)
    ...
    def test_validate_fk_directive_suggestions(self, validator):
        ...
        result = validator.validate_foreign_key_directive("site", "location", "@value:invalid.path", is_local=False)
