...
class DataSourceConfig(BaseModel):
    ...
    options: Optional[dict[str, Any]] = Field(
        None, 
        description="Driver-specific options (e.g., ucanaccess_dir for Access, pandas options for CSV)"
    )
...
class DataSourceTestResult(BaseModel):
    ...
    metadata: Optional[dict[str, Any]] = Field(
        None, 
        description="Additional metadata (e.g., database version, table count)"
    )
...
class DataSourceStatus(BaseModel):
    ...
    last_test_result: Optional[DataSourceTestResult] = Field(
        None, 
        description="Result of last connection test"
    )
    in_use_by_entities: list[str] = Field(
        default_factory=list, 
        description="Entity names using this data source"
    )
