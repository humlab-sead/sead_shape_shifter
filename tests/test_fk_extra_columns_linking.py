    ...
    return {
        ...
        "entities": {
            "sample_description_type": {
                ...
                "values": [[1, None, "Biological Age", "The (infered) age or development stage"]],
            },
            "sample_description": {
                "type": "entity",
                "source": "datasheet",
                ...
                "foreign_keys": [
                    {"entity": "sample_description_type", "local_keys": ["description_type_id"], "remote_keys": ["system_id"]}
                ],
                "extra_columns": {"description_type_id": 1},
            },
        },
    }
    ...
    project_config = {
        ...
        "entities": {
            ...
            "child": {
                ...
                "public_id": "child_id",
                "columns": ["child_name"],
                "foreign_keys": [{"entity": "parent", "local_keys": ["parent_ref"], "remote_keys": ["system_id"]}],
