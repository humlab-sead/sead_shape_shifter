...
from src.configuration.resolve import IncludeResolver
...
class TestBaseResolverPathResolution:
    ...
    def test_resolve_absolute_path_unchanged(self, resolver: IncludeResolver) -> None:
    ...
    def test_resolve_with_env_var_and_absolute(self, resolver: IncludeResolver) -> None:
    ...
    def test_resolve_relative_without_base_path(self, resolver: IncludeResolver) -> None:
    ...
    def test_resolve_relative_with_base_path(self, resolver: IncludeResolver, tmp_path: Path) -> None:
    ...
    def test_resolve_current_dir_relative(self, resolver: IncludeResolver, tmp_path: Path) -> None:
    ...
    def test_resolve_parent_dir_relative(self, resolver: IncludeResolver, tmp_path: Path) -> None:
    ...
    def test_resolve_env_var_with_relative_and_base(self, resolver: IncludeResolver, tmp_path: Path) -> None:
    ...
    def test_resolve_empty_string(self, resolver: IncludeResolver) -> None:
        """Test that empty string is returned as-is."""
        result = resolver._resolve_path("")
        assert result == ""

    def test_resolve_none_base_path(self, resolver: IncludeResolver) -> None:
    ...
    def test_resolve_with_unresolved_vars_no_raise(self, resolver: IncludeResolver) -> None:
    ...
    def test_resolve_with_unresolved_vars_raise(self, resolver: IncludeResolver) -> None:
    ...
    def test_resolve_with_multiple_unresolved_vars_raise(self, resolver: IncludeResolver) -> None:
...
class TestPathResolverIntegration:
    ...
    def test_global_data_dir_pattern(self, resolver: IncludeResolver, tmp_path: Path) -> None:
    ...
    def test_include_directive_pattern(self, resolver: IncludeResolver, tmp_path: Path) -> None:
    ...
    def test_local_relative_include(self, resolver: IncludeResolver, tmp_path: Path) -> None:
    ...
    def test_shared_resource_pattern(self, resolver: IncludeResolver, tmp_path: Path) -> None:
    ...
    def test_windows_style_path(self, resolver: IncludeResolver) -> None:
    ...
    def test_mixed_env_vars_and_paths(self, resolver: IncludeResolver, tmp_path: Path) -> None:
...
class TestPathResolverEdgeCases:
    ...
    def test_resolve_with_special_characters(self, resolver: IncludeResolver) -> None:
    ...
    def test_resolve_with_unicode(self, resolver: IncludeResolver) -> None:
    ...
    def test_resolve_empty_env_var_value(self, resolver: IncludeResolver) -> None:
        """Test behavior when env var exists but is empty."""
        os.environ["EMPTY_VAR"] = ""
        result = resolver._resolve_path("${EMPTY_VAR}/file.txt")
        assert result == "/file.txt"

    def test_resolve_partial_env_var_syntax(self, resolver: IncludeResolver) -> None:
    ...
    def test_resolve_dollar_without_braces(self, resolver: IncludeResolver) -> None:
