...
## Corpus Check
- 857 files · ~798,856 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18957 nodes · 42239 edges · 753 communities (637 shown, 116 thin omitted)
- Extraction: 75% EXTRACTED · 25% INFERRED · 0% AMBIGUOUS · INFERRED: 10542 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0ecb92f0`
...
## Communities (753 total, 116 thin omitted)

### Community 0 - "Project"
Cohesion: 0.03
Nodes (64): ValidationService, CoreIssue, test_from_core_issue_maps_conformance_defaults(), test_from_core_issue_maps_validation_issue(), test_from_core_issue_uses_column_as_field_fallback(), OutputFormat, Models for configuration test runs., Output format for test run results. (+56 more)

### Community 1 - "ProjectService"
Cohesion: 0.01
Nodes (138): Entity schema validation failure.      Common causes:     - Missing required fie, SchemaValidationError, Any, DataFrame, Path, Project, ProjectService, DefaultEntityPersistenceStrategy (+130 more)

### Community 2 - "derive_fixed_schema"
Cohesion: 0.02
Nodes (125): ValidationResult, Any, Path, ProjectService, ProjectTaskStatus, ShapeShiftProject, ShapeShiftService, TaskListSidecarManager (+117 more)

### Community 3 - "specifications/test_entity.py"
Cohesion: 0.01
Nodes (195): Path, Any, Settings, Any, Entity, Project, ShapeShiftProject, Settings (+187 more)
...
Cohesion: 0.03
Nodes (107): Reconciliation service module.  This module provides services for entity reconci, EntityResolutionSet, ProjectService, ShapeShiftProject, Any, AutoReconcileResult, EntityResolutionCatalog, EntityResolutionSet (+99 more)
...
Cohesion: 0.04
Nodes (48): Client for SEAD OpenRefine reconciliation service., Initialize reconciliation client.          Args:             base_url: Base URL, ReconciliationClient, Unit tests for ReconciliationClient.  Tests cover: - ReconciliationQuery initial, Test that _get_client creates HTTP client., Test that _get_client reuses existing client., Test that close properly cleans up HTTP client., Test that close works when no client exists. (+40 more)

### Community 8 - "ColumnSpec"
Cohesion: 0.03
Nodes (90): Mapper for translating between domain validation models and API validation model, Registry, ConformanceValidationExecutor, DataValidationExecutor, execute(), load_project(), main(), normalize_workflow_name() (+82 more)
...
Cohesion: 0.03
Nodes (53): ExcelLoader, OpenPyxlLoader, PandasLoader, Loader for Excel files using openpyxl., Parse a column range like 'A:I' or 'B:Z' and return (min_col, max_col)., Load data from a sheet in an Excel file into a DataFrame., Loader for Excel files., Test file-based connection (Excel). (+45 more)

### Community 11 - "FixedEntityPersistenceStrategy"
Cohesion: 0.05
Nodes (89): MembershipLookupStatus, Result states returned by a membership provider., _apply_administrators(), _apply_grants(), apply_manifest(), _apply_resources(), backup_database(), initialize_database() (+81 more)
...
Cohesion: 0.04
Nodes (32): DummySqlLoader, Should create TableMetadata dict from DataFrame., Should get table schema from PostgreSQL., Should use 'public' schema by default., Should get tables from SQLite., Should get table schema from SQLite., Should get tables from MS Access database., Should get table schema from MS Access database. (+24 more)

### Community 14 - "UCanAccessSqlLoader"
Cohesion: 0.02
Nodes (117): QueryExecutionError, QuerySecurityError, Query execution failed.      Common causes:     - Data source connection issues, Query contains prohibited operations.      Occurs when query attempts destructiv, AuthorizedResource, DataSourceConfig, DataSourceService, Depends (+109 more)

### Community 15 - "schema_reference.py"
Cohesion: 0.07
Nodes (80): Any, AuthorizedResource, AutoReconcileResult, Depends, EDIT, EntityResolutionCatalog, EntityResolutionListItem, READ (+72 more)
...
Cohesion: 0.04
Nodes (56): Any, Connection, Any, DataFrame, Self, Submission, T, compress_and_encode() (+48 more)
...
Cohesion: 0.03
Nodes (71): DirectiveResolver, EnvironmentVariableResolver, find_unresolved_directives(), IncludeResolver, _is_path_env_var(), load_resolved_yaml(), LoadResolver, _raise_on_unresolved_directives() (+63 more)

### Community 24 - "get_data_source_status"
Cohesion: 0.05
Nodes (57): Any, AuthorizedResource, DataValidationMode, Depends, EDIT, READ, require_project, Business logic services.  This module provides centralized access to all service (+49 more)

### Community 25 - "EntityValuesService"
Cohesion: 0.05
Nodes (35): ShapeShiftProject, _core_project(), initialize_jvm(), Initialize JVM once for all tests in this module., Load the backend integration test project configuration for each test., test_check_circular_dependencies(), test_composite_project_specification_is_satisfied_by(), test_data_validation_orchestrator() (+27 more)

### Community 26 - "UnnestConfig"
Cohesion: 0.03
Nodes (44): Data source configuration mapper between API and core models., Tests for entity materialization functionality., Test MaterializationConfig model., TestMaterializationConfig, Unit tests for arbodat utility configuration classes., Test creating a valid unnest configuration., Test that missing unnest key raises ValueError., Test that missing id_vars is allowed (defaults to empty list). (+36 more)

### Community 27 - "src/utility.py"
Cohesion: 0.03
Nodes (128): SubmissionContext, TargetModel, ChangeRequestTable, datetime, DeployArtifact, ChangeRequestPackage, IdentityResolutionResult, PlannedTable (+120 more)
...
Cohesion: 0.03
Nodes (117): TargetModel, TargetModel, DataFrame, EntitySpec, IdentityResolutionResult, TargetModel, TargetProjectionResult, Any (+109 more)

### Community 30 - "app/models/__init__.py"
Cohesion: 0.05
Nodes (55): ApplicationRoleAssignment, AuditEvent, Centralized authorization primitives and policy services., MembershipSnapshot, A point-in-time group membership lookup result., ApplicationRole, ApplicationRoleAssignment, AuditEvent (+47 more)
...
Cohesion: 0.07
Nodes (39): Server-owned resource record and current locator., Return the stable identity without exposing its locator., ResourceRecord, _principal(), Tests for the centralized authorization foundation., test_deleted_resource_name_can_be_reused_without_inheriting_grants(), test_group_and_authenticated_everyone_grants_match_verified_subjects(), test_project_grant_is_inherited_by_child_and_persists() (+31 more)

### Community 33 - "MaterializationService"
Cohesion: 0.02
Nodes (162): AuthorizationService, DataSourceConfig, DataSourceStatus, DataSourceTestResult, Principal, DataSourceConfig, Path, SqlLoader (+154 more)
...
Cohesion: 0.04
Nodes (65): Config, ConfigLike, load_config(), Create a deep copy of the configuration., Resolve configuration directives in self.data., Container for configuration elements., Save configuration to the YAML file.          This method preserves the raw YAML, Configurable (+57 more)
...
Cohesion: 0.09
Nodes (34): init_jvm_for_ucanaccess(), Initialize the JVM for UCanAccess JDBC driver.      This function should be call, initialize_jvm(), Initialize JVM once for all tests in this module., check_regression_of_shapes(), initialize_jvm(), Initialize JVM once for all tests in this module., remove_path() (+26 more)
...
Cohesion: 0.05
Nodes (47): Any, Path, Path, ProjectService, CommentedMap, CommentedSeq, CommentRegistry, Service for managing graph layout sidecar files (shapeshifter.layout.yml).  Cust (+39 more)

### Community 43 - "._validate_entity"
Cohesion: 0.17
Nodes (8): DataFrame, TableConfig, Resolve the source DataFrame for the given entity based on its configuration., Extract, transform, and store a single entity through the full pipeline., Check for duplicate keys in the processed table and log an error if found., Re-evaluate deferred extra_columns for an entity after FK linking or unnesting., Apply committed sidecar links to the entity's public_id column.          Sidecar, Resolve `location: local` file paths relative to the project file directory.
...
Cohesion: 0.03
Nodes (49): Tests for reconciliation mappers., Test converting mapping item DTO to domain., Test converting source DTO to domain., Test converting mapping item domain to DTO., Test DTO -> Domain -> DTO roundtrip., Test EntityResolution DTO <-> Domain mapping., Test converting entity mapping DTO to domain with string source., Test converting entity mapping with custom ReconciliationSource. (+41 more)

### Community 47 - "ForeignKeyConfig"
Cohesion: 0.03
Nodes (94): Any, PreviewResult, ProjectService, ShapeShiftProject, TableConfig, TableStore, DataFrame, ShapeShiftProject (+86 more)
...
Cohesion: 0.04
Nodes (74): IngesterConfig, Configuration for an ingester instance.      This is the base configuration clas, Test IngesterConfig default values., Test IngesterConfig with all fields specified., expected_bundle_name(), FakeCollisionChecker, FakeReconciliationClient, FakeSimsClient (+66 more)
...
Cohesion: 0.03
Nodes (115): DispatcherRegistry, IDispatcher, Registry for dispatcher classes., Process a primary key or non-foreign-key column value., Process a foreign key column value., Convert value to None if it's NaN or None., Main dispatch method that processes submission and creates CSV files.          A, Process a single table and collect data for CSV export. (+107 more)
...
Cohesion: 0.06
Nodes (70): Any, AuthorizedResource, Depends, EDIT, ProjectTaskStatus, READ, require_project, YamlService (+62 more)
...
Cohesion: 0.05
Nodes (108): SubmissionContext, IdentityOrchestrationResult, Any, Path, SubmissionContext, Any, IngesterConfig, IngesterMetadata (+100 more)
...
Cohesion: 0.03
Nodes (78): TargetModel, SubmissionContext, IdentityWorkPlan, DataFrame, PlannedTable, Any, IdentityAssignment, PlannedTable (+70 more)
...
Cohesion: 0.03
Nodes (159): AuthorizationService, AuthorizedResource, DataSourceConfig, DataSourceService, DataSourceStatus, DataSourceTestResult, Depends, get_authorization_service (+151 more)
...
### Community 77 - "unnest"
Cohesion: 0.03
Nodes (88): Any, Path, ProjectService, ValidationError, FixAction, FixResult, FixSuggestion, FixAction (+80 more)
...
Cohesion: 0.03
Nodes (127): EntitySuggestions, SchemaIntrospectionService, Any, EntitySuggestions, SchemaIntrospectionService, TableSchema, MonkeyPatch, TableSchema (+119 more)
...
Cohesion: 0.02
Nodes (117): CsvProcessor, Write collected data to CSV files., Main class that processes the Submission and produces CSV files directly.      C, IDispatcher, Column, SeadSchema, Table, SeadSchema (+109 more)
...
Cohesion: 0.04
Nodes (49): Identifier, Statement, SQL Query execution service for the Shape Shifter Configuration Editor., Validate a SQL query for safety and syntax.          Args:             query: SQ, _find_forbidden_operation(), _has_executable_tokens(), Statement, Result of validating SQL against the shared read-only execution policy. (+41 more)
...
Cohesion: 0.01
Nodes (201): Any, AuthorizedResource, Depends, EDIT, MaterializationService, READ, require_project, Any (+193 more)
...
Cohesion: 0.02
Nodes (85): ProjectService, ShapeShiftService, ShapeShiftService, Test circular dependency with three entities: A -> B -> C -> A., Test circular dependency handling with defer_dependency flag., Test that defer_dependency defaults to False (backward compatible)., Test that circular dependencies fail without defer_dependency flag (current beha, Test entity with multiple FKs, some deferred and some not. (+77 more)
...
Cohesion: 0.10
Nodes (37): ForeignKeyConstraintValidator, ForeignKeyRuntimeOptions, ForeignKeyConstraintValidator, ForeignKeyRuntimeOptions, Orchestrates validation of foreign key constraints during and after merging., Resolved runtime behavior for foreign-key null handling., build_fk(), build_project() (+29 more)
...
Cohesion: 0.16
Nodes (8): Project, Get all active sessions for a project file., Get the currently active project being edited., Get a specific project from active editing sessions., Set/update the active project.          Args:             project: Project to se, Check if project has unsaved changes., Get project version for cache invalidation., Load active project from ApplicationState if available.
...
Cohesion: 0.12
Nodes (14): PlainTextResponse, get_settings(), Application configuration., Get cached settings instance., get_help_doc(), API endpoints for markdown help documents used by the frontend., Return a markdown document used by the Help view., download_logs() (+6 more)
...
Cohesion: 0.15
Nodes (11): GroupMembershipResolver, HttpGroupMembershipResolver, Trusted group-membership lookup for authorization review., Resolve group members from a trusted identity authority., Return the current review result for one group., Read group members from a configured trusted HTTP provider., Fetch one group's members without changing authorization state., Tests for trusted group-membership review. (+3 more)
...
Cohesion: 0.18
Nodes (7): UUID, get_app_state(), Application-level state management for multi-user configuration editing., Release a session and clear project if no other sessions., Periodically cleanup inactive sessions (30min timeout)., Get the application state singleton., Start background tasks.

### Community 132 - "validate_project.py"
Cohesion: 0.04
Nodes (186): Adapters from authenticated request state to authorization principals., Create a dependency that checks session ownership and current project access., require_authorized_session(), Principal, Stable identity used for grant lookup., AuthorizationService, Evaluate resource and application access using one policy and repository., DataSourceService (+178 more)
...
Cohesion: 0.03
Nodes (61): Path, ApplicationState, Path, Project, init_app_state(), Initialize application state (called in lifespan)., app_state(), project_dir() (+53 more)

### Community 138 - "Config"
Cohesion: 0.21
Nodes (6): _format_value(), Convert value to int or return None if conversion fails., Format value according to its data type for CSV output., _to_int_or_none(), Test helper functions used by CsvProcessor., TestHelperFunctions
...
Cohesion: 0.01
Nodes (341): Raised when a sidecar ``EntityMapping`` fails validation against its entity conf, SidecarValidationError, ProjectSpecification, Base specification for project validation., AppendSpecification, DataEntityFieldsSpecification, DependsOnResolvedSpecification, DependsOnSpecification (+333 more)
...
Cohesion: 0.05
Nodes (14): Metadata, Any, Configuration metadata. Read-Only. Wraps metadata section from configuration., Initialize metadata from configuration data., Configuration description., Configuration version., Configuration version., Get configuration metadata. (+6 more)
...
Cohesion: 0.12
Nodes (29): Any, Identifier, ReconciliationClient, Settings, SubmissionContext, Query for reconciliation service., ReconciliationQuery, Composed (+21 more)
...
Cohesion: 0.01
Nodes (323): AuthorizedResource, Depends, EDIT, EntityMapping, Link, READ, require_project, AuthorizedResource (+315 more)
...
Cohesion: 0.06
Nodes (36): Path, ProjectFileInfo, UploadFile, Any, Path, FileLocation, Sanitize uploaded filename to prevent path traversal.          Args:, List files stored under a project's uploads directory.          Args: (+28 more)
...
Cohesion: 0.06
Nodes (29): DuckDbLoader, SQL loader over Shape Shifter's internal table_store.      This loader does not, DuckDbLoader, loader(), Tests for DuckDbWorkspace and DuckDbLoader., Unregistering a name that was never registered should not raise., Verify that TableStore hooks keep the workspace in sync automatically., Tests for the DuckDbLoader.create() factory classmethod. (+21 more)
...
Cohesion: 0.06
Nodes (38): global_exception_handler(), Catch all unhandled exceptions and log with full traceback.      This is a last-, Verify every declared protected endpoint rejects a request before handler valida, test_declared_authorization_routes_reject_unauthenticated_requests(), Exception, Request, Request, Response (+30 more)
...
Cohesion: 0.04
Nodes (31): CircularDependencySpecification, Validates that there are no circular dependencies between entities., Check for circular dependencies in the entity graph., Tests for project-level specifications., Test validation passes with empty entities., Test validation passes when entities key missing., Tests for DataSourceExistsSpecification., Test validation passes when all data sources exist. (+23 more)

### Community 238 - "Playwright E2E Testing Setup - Complete! ✅"
Cohesion: 0.09
Nodes (29): decode_local_key(), _decode_single(), Split an encoded compound key on unescaped ``|`` characters., Decode a string key back into individual component values.      Reverses the enc, Decode a single value: ``<NULL>`` back to empty string, unescape., _split_compound(), _normalise_local_key(), Sidecar validation functions for ``<project>-mapping.yml`` alignment.  These val (+21 more)

### Community 239 - ".__init__"
Cohesion: 0.03
Nodes (34): TaskListSidecarManager, Tests for TaskListSidecarManager service., Test load_task_list returns full data when sidecar has no explicit task_list key, Test save_task_list creates sidecar file., Test save_task_list saves correct format (new format with migration)., Tests for TaskListSidecarManager class., Test save_task_list creates parent directory if needed., Saving task state should not remove persisted notes. (+26 more)
...
Cohesion: 0.11
Nodes (23): get_data_source_service(), Get DataSourceService instance.      Creates service for managing global data so, QueryExecution, QueryIntrospection, QueryResult, QueryValidation, Query execution models for the Shape Shifter Configuration Editor., Result of a query execution. (+15 more)
...
Cohesion: 0.02
Nodes (160): ConfigurationError, EntityConflictError, Invalid project configuration.      Occurs when project structure violates speci, Base class for resource access/availability errors., Requested resource does not exist.      Used for projects, entities, files, etc., Resource already exists with same identifier.      Used for duplicate names, ID, Entity was concurrently modified; ETag mismatch.      Raised when a PUT /entitie, ResourceConflictError (+152 more)
...
Cohesion: 0.09
Nodes (21): DataFrame, ConfigLike, SchemaService, SeadSchema, Submission, Full schema loaded from CSV - session scoped, use for integration tests only., MockSchemaService, Returns foreign key columns from SEAD columns (performance only). (+13 more)
...
Cohesion: 0.04
Nodes (44): Tests for base specification classes and utilities., dotexpand(), filter_once_per_message(), get_connection_uri(), import_sub_modules(), import_submodules(), load_resource_yaml(), Any (+36 more)
...
Cohesion: 0.13
Nodes (24): AuthenticationAdapter, AuthenticationAdapter, Convert trusted-proxy identity state into a stable principal., authorize_shared_data_source_reference(), _data_source_locator(), get_authorization_repository(), get_authorization_service(), get_principal() (+16 more)
...
Cohesion: 0.14
Nodes (10): ShapeShiftProject, TableConfig, Cache DataFrame for entity with metadata including entity hash.          Args:, Cache all entities from table_store individually with entity hashes.          Ar, Gather all cached dependencies for an entity with hash validation.          Args, Return the on-disk mtime of a cached project's YAML file, or None if unavailable, Record file path and mtime from a freshly loaded API project., Get ShapeShiftProject with caching and version tracking.          Uses Applicati (+2 more)
...
Cohesion: 0.16
Nodes (18): MonkeyPatch, ShapeShiftProject, build_config(), patch_config_resolution(), preview_service(), Tests for ValidateForeignKeyService., Raise when local preview data is missing join keys., Detect duplicate matches and mismatched cardinality recommendations. (+10 more)
...
Cohesion: 0.11
Nodes (17): AuthorizationPolicy, Evaluate explicit role mappings without implicit allow rules., Return whether a resource role permits an action for its resource type., Return whether an application role permits an application action., Return whether the principal may perform an action on a resource., Return an authorized resource or None when access is denied., Return whether a principal holds an application role that allows an action., Create a project resource and assign its initial owner. (+9 more)
...
Cohesion: 0.03
Nodes (54): DataFrame, Domain validators for data quality checks., ColumnExistsValidator, DataTypeCompatibilityValidator, ForeignKeyDataValidator, ForeignKeyIntegrityValidator, NaturalKeyUniquenessValidator, NonEmptyResultValidator (+46 more)
...
Cohesion: 0.12
Nodes (9): Test suite for FilePathResolver utility class., Test extracting location with subdirectory in legacy format., Test converting to legacy format for global file., Test converting to legacy format for local file., Test resolving empty filename still returns valid path., Test decomposing directory (not file) path., Test resolve_in_entity_config with config missing options., Test that parent traversal cannot escape the configured root. (+1 more)
...
Cohesion: 0.13
Nodes (8): FilePathResolver, Test decomposing local file with subdirectory., Test extracting location from legacy ${GLOBAL_DATA_DIR}/ format., Test extracting location from plain filename (defaults to local)., Test resolving local (project-specific) file path., Test that resolving local file without project_name raises ValueError., Test that invalid location raises ValueError., Test that project-name path variants cannot escape the projects root.
...
Cohesion: 0.24
Nodes (9): Analyze dependencies in project.         Args:              api_project: Project, calculate_depths(), find_cycles(), Find all cycles in dependency graph using DFS.      Args:         dependency_map, Perform topological sort on dependency graph.      Args:         dependency_map:, Calculate depth of each node in dependency graph.      Args:         dependency_, topological_sort(), Utility modules for the backend application.  This package contains reusable uti (+1 more)
...
Cohesion: 0.13
Nodes (17): EntityResolutionCatalog, EntityResolutionListItem, EntityResolutionSet, Path, ProjectService, ResolutionTarget, EntityMappingManager, Create a new entity resolution mapping.          Works with domain models throug (+9 more)
...
Cohesion: 0.05
Nodes (27): client(), Validate route should preserve change-request payload fields when calling the se, Test ingestion with non-existent ingester., Test ingestion with invalid request body., Test ingestion response structure., Ingest route should preserve change-request payload fields when calling the serv, Create a fresh TestClient so app startup runs inside the test., Test GET /api/v1/ingesters endpoint. (+19 more)
...
Cohesion: 0.07
Nodes (32): 10. Dispatch and Data Ingestion, 12. YAML Editing, 16. Additional Documentation, 1. Introduction, 2. Quick Start, 9. Execute and Export, After Execution, Before You Start Editing (+24 more)

### Community 609 - ".__init__"
Cohesion: 0.02
Nodes (120): SeadSchema, Integration tests for append feature end-to-end functionality., Test append feature with full normalization pipeline., Test append with distinct mode removes duplicates., Test appending fixed data to entity., Test append with all mode keeps duplicates., Test appending from multiple sources., Test that public_id column is properly handled in append configurations. (+112 more)

### Community 610 - "Community 610"
Cohesion: 0.20
Nodes (6): Test verify_extra_columns method for validation., Test verify returns True when all columns are evaluated., Test verify returns False and logs warning when columns are missing., Test verify returns True when no extra_columns configured., Test verify detects partially missing columns., TestVerifyExtraColumns
...
Cohesion: 0.03
Nodes (83): Schema introspection failed.      Common causes:     - Data source not connected, SchemaIntrospectionError, Any, DataFrame, DataSourceConfig, SchemaIntrospectionService, Settings, ColumnMetadata (+75 more)
...
Cohesion: 0.25
Nodes (5): Tests for extra_columns evaluation with interpolated string support., Test DSL formula detection and literal escaping., Single leading '=' indicates a DSL formula., Double leading '=' is treated as a literal string, not a DSL formula., TestDslFormulaDetection
...
Cohesion: 0.25
Nodes (5): Test deferred evaluation workflow (simulate FK linking)., Deferred interpolation can be evaluated after columns added., Multiple deferred columns can be evaluated together., Some deferred columns resolve, others still missing., TestDeferredEvaluation
...
Cohesion: 0.08
Nodes (47): Create a dependency that authorizes an application-scoped action., Authorize access to an operation owned by the current principal and project., Create a dependency that authorizes a project locator for an action., Create a dependency that authorizes a shared data source locator for an action., require_application_action(), require_operation(), require_project(), require_shared_data_source() (+39 more)
...
Cohesion: 0.33
Nodes (4): Client package initialization., HTTP client for OpenRefine reconciliation service API., Candidate entity returned by reconciliation service., ReconciliationCandidate
...
Cohesion: 0.50
Nodes (3): Return the request principal or raise the standard authentication response., Principal, Request
...
- **Why does `TableConfig` connect `TableConfig` to `derive_fixed_schema`, `specifications/test_entity.py`, `AutoFixService`, `ColumnSpec`, `public.tbl_locations`, `TaskListSidecarManager`, `ProjectDetailView.vue`, `TestShapeShiftProject`, `ExtraColumnEvaluator`, `_make_operations`, `DataFrame`, `EntityValuesService`, `UnnestConfig`, `CreateEntityFromTableDialog.vue`, `ExcelDispatcher`, `QueryBuilder.vue`, `MaterializationService`, `Any`, `SubsetService`, `Community 803`, `03_functions.sql`, `TargetModel`, `._validate_entity`, `ReconciliationGrid.vue`, `ForeignKeyConfig`, `01_tables.sql`, `process_merged_branch`, `test_validate_fk_service.py`, `SourceSpan`, `SchemaService`, `conformance.py`, `project_mapper.py`, `EntityOperations`, `FilePathResolver`, `TestShapeShiftServiceIncludeBug`, `DuckDbWorkspace`, `QueryService`, `public.tbl_methods`, `TestTaskListSidecarManager`, `.__init__`, `type`, `DeferredLinkingTracker`, `recursive_update`, `EntitySpec`, `EntityMappingManager`, `mock_config`, `Community 744`, `ReconciliationProgressDialog.vue`, `.validate_project`, `Proposal: BugsCEP Importer Migration Runtime Decision Spike`, `Playwright E2E Testing Setup - Complete! ✅`, `get_ingester_service`, `EntityPreviewPanel.vue`, `ReconciliationQueryService`, `.get_subset2`, `DataSourceConfig`, `ShapeShifter`, `MaterializationSpecification`, `Settings`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `ShapeShiftProject` connect `DeferredLinkingTracker` to `Project`, `derive_fixed_schema`, `specifications/test_entity.py`, `TableConfig`, `AutoFixService`, `validate_project.py`, `ColumnSpec`, `UCanAccessSqlLoader`, `TestShapeShiftProject`, `ValidationError`, `DataFrame`, `get_data_source_status`, `EntityValuesService`, `UnnestConfig`, `SEAD Clearinghouse Ingester - Architecture Overview`, `CreateEntityFromTableDialog.vue`, `ExcelDispatcher`, `QueryBuilder.vue`, `Community 803`, `tests/test_utility.py`, `TargetModel`, `._validate_entity`, `ForeignKeyConfig`, `DataSourceService`, `IngesterService`, `.folder`, `TestYamlEntityKeyOrdering`, `SourceSpan`, `conformance.py`, `EntityOperations`, `FilePathResolver`, `TestShapeShiftServiceIncludeBug`, `useTaskStatusStore`, `public.tbl_methods`, `TestTaskListSidecarManager`, `.__init__`, `type`, `EntitySpec`, `EntityMappingManager`, `Community 744`, `.mock_settings`, `ReconciliationProgressDialog.vue`, `.validate_project`, `EntityPreviewPanel.vue`, `configuration/utility.py`, `ReconciliationQueryService`, `DataSourceConfig`, `What's New in v1.16.0`, `MaterializationSpecification`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `enum` connect `Project` to `Reconciliation Workflow - User Guide`, `MaterializationService`, `derive_fixed_schema`, `AutoFixService`, `FixedLoader`, `SeadChangeRequestSimsAdapter`, `unnest`, `OperationManager`, `ReconciliationClient`, `IngesterService`, `SourceSpan`, `IdentityResolutionResult`, `app/models/__init__.py`?**
