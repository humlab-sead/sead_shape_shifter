<template>
  <div v-if="embedded">
    <!-- Embedded mode: No outer card, just content with divider -->
    ...
    <!-- Error Display -->
    <v-alert v-else-if="error" type="error" variant="tonal" density="compact" closable @click:close="clearError" class="mb-2">
      {{ error }}
    </v-alert>
