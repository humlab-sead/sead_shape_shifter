...
├── .env                # deployment defaults, generated by make setup (untracked)
...
├── resources/          # backend.env.example, .pgpass.example, NGINX vhosts
└── lib/                # UCanAccess JARs (untracked)
...
| Command                  | Purpose                                             |
|--------------------------|-----------------------------------------------------|
| `make setup`             | Create `.env`, data directories and environment files |
